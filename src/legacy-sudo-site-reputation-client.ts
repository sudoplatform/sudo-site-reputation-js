...
export enum Status {
   ...
   * to {@link LegacySudoSiteReputationClient.getSiteReputation}.
   */
  Preparing = 'preparing',
   ...
   * process calls to {@link LegacySudoSiteReputationClient.getSiteReputation}.
   */
...
/**
 * Return type of {@link LegacySudoSiteReputationClient.getSiteReputation}
 */
export interface LegacySiteReputation {
  /** Returns `true` if malicious, `false` if not. */
  isMalicious: boolean
}

export interface LegacySudoSiteReputationClientProps {
  /**
   ...
   * {@link LegacySudoSiteReputationClient.status} changes.
   */
 ...
 * Each instance of `LegacySudoSiteReputationClient` will be configured with
 * a ruleset from a ruleset provider to check a site's reputation against.
 * To determine a site's reputation, you can
 * call {@link LegacySudoSiteReputationClient.getSiteReputation}.
 */
export class LegacySudoSiteReputationClient {
  ...
  constructor(private props: LegacySudoSiteReputationClientProps) {
    this.config =
      props?.config ??
  ...
  /**
   * Returns a {@link LegacySiteReputation} with SiteReputationData.isMalicious
   * set to true if `url` is malicious; false if not.
   * @param url A full URL or domain
   * @deprecated Use SudoSiteReputationClient.getSiteReputation instead.
   */
  public async getSiteReputation(url: string): Promise<LegacySiteReputation> {
   ...
   * queries to {@link LegacySudoSiteReputationClient.getSiteReputation}.
   */
