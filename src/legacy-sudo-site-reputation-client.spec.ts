...
const testProps: LegacySudoSiteReputationClientProps = {
  config: {} as any,
...
describe('LegacySudoSiteReputationClient', () => {
  describe('construction', () => {
    it('should set ruleset in storage', async () => {
      const siteReputationClient = new LegacySudoSiteReputationClient(testProps)
    ...
    it('should set client in Status.Error if initialize fails', async () => {
      ...
      const siteReputationClient = new LegacySudoSiteReputationClient({
        ...testProps,
    ...
    it('should initialize from cached data', async () => {
      ...
      const client = new LegacySudoSiteReputationClient(testProps)
